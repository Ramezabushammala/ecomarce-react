...
import AddProdactHook from "../../hookLogic/Prodact/AddProdactHook";

const AdminAddProducts = () => {
  
  const info =AddProdactHook();
  return (
    <div>
      ...
      <Row>
        <Col sm="8" className="d-flex justify-content-end ">
          <button onClick={info.handelSubmitdata} className="btn-save d-inline mt-2 "> اضافة المنتج</button>
        </Col>
        <ToastContainer />
      </Row>
    </div>
